...
namespace Contributors.Infraestructure.Logging
{
    public class LogAzure : ILogAzure
    {
        ...
        public void Setup(CustomJwtTokenContext context, string pnameMethod, ApplicationType application, string api)
        {
            pasos = new List<StepProcess>();
            LoadConfig();
